...
data master_ad;
	...
	if outcomed = 11 & bfresult = 1 then dement_B = 1; /*using same logic as Wu code for wave A*/
	else if bfresult = 1 & outcomec NE 11 then dement_B = 0;

	if outcomed = 21 & cfresult = 1 then dement_C = 1; /*using same logic as Wu code for wave A*/
	else if cfresult = 1 & outcomec NE 21 then dement_C = 0;

	if outcomed = 31 & dfresult = 1 then dement_D = 1; /*using same logic as Wu code for wave A*/
